...
const GtmReadinessOutputSchema = z.object({
    ...
    implementationTimelineOverview: z.string().describe('Start with a summary paragraph providing an overview of the implementation approach. Then, detail the timeline using ### for each phase title (e.g., ### Phase 1: Foundation & Alignment (0-30 Days)).'),
