...
export function QuickActionProvider({ children }: { children: React.ReactNode }) {
  ...
  const contextValue = React.useMemo(() => ({
    ...
    isEditProjectDialogOpen, openEditProjectDialog, closeEditProjectDialog, onProjectUpdatedRef, editProjectData, setOnProjectUpdated,
    ...
    isAddFromLibraryDialogOpen, openAddFromLibraryDialog, closeAddFromLibraryDialog, addFromLibraryData, setOnAddFromLibrary,
    globalSearchTerm
  ]);
