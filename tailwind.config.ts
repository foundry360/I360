  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        'spin-medium': { from: { transform: 'rotate(0deg)' }, to: { transform: 'rotate(-360deg)' }},
        'spin-fast': { from: { transform: 'rotate(0deg)' }, to: { transform: 'rotate(360deg)' }},
        'spin-slower': { from: { transform: 'rotate(0deg)' }, to: { transform: 'rotate(-360deg)' }},
        'spin-medium-reverse': { from: { transform: 'rotate(0deg)' }, to: { transform: 'rotate(360deg)' }},
      },
      animation: {
        ...
        'spin-medium-reverse': 'spin-medium-reverse 3.5s linear infinite',
      },
    },
  },
